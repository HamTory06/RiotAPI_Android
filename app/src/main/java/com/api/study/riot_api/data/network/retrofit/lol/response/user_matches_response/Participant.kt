...
data class Participant(
    ...
    val basicPings: Int,
    val bountyLevel: Int,
    val challenges: com.api.study.riot_api.data.network.retrofit.lol.response.user_matches_response.Challenges,
    ...
    val pentaKills: Int,
    val perks: com.api.study.riot_api.data.network.retrofit.lol.response.user_matches_response.Perks,
